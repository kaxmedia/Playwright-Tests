...
//   npx playwright test tests/journeys/account-brand.spec.ts --grep @regression
//
// Design principles:
...
test.describe('Journey 8.1 — Sign-up (register modal)', () => {
    ...
    test('@regression sign-up modal is present in the DOM @journey', async () => {
        // #signup-modal reuses the same shell for sign-in and logged-in profile menu
        await expect(authPage.signupModal).toBeAttached();
    });

    test('@regression register form fields are present in the modal @journey', async ({ page }) => {
...
test.describe('Journey 8.2 — Returning user (sign-in flow)', () => {
    ...
    test('@regression sign-in form exposes email and password fields @journey', async () => {
...
test.describe('Journey 8.3 — Rewards check (profile page)', () => {
    ...
    test('@regression profile page exposes a sign-in prompt for unauthenticated users @journey', async ({ page }) => {
...
test.describe('Journey 8.4 — Predictor leaderboard', () => {
    ...
    test('@regression leaderboard page loads with H1 @journey', async ({ page }) => {
        await expect(page).toHaveURL(/\/ie\/games\/tournaments/);
        await expect(page.locator('h1').first()).toBeVisible();
    });

    test('@regression leaderboard table is present @journey', async () => {
        await expect(tournamentsPage.leaderboard).toBeAttached();
    });

    test('@regression unauthenticated entry CTA is present for new picks @journey', async () => {
...
test.describe('Journey 8.6 — Geo homepage (UK market)', () => {
    ...
    test('@regression UK geo homepage exposes vertical navigation to a toplist @journey', async ({ page }) => {
...
test.describe('Journey 8.7 — Reviews hub', () => {
    ...
    test('@regression reviews hub exposes individual operator review links @journey', async ({ page }) => {
...
test.describe('Journey 8.8 — News reader', () => {
    ...
    test('@regression opening an article from the news hub works @journey', async ({ page }) => {
...
test.describe('Journey 8.9 — Responsible gambling hub', () => {
    ...
    test('@regression responsible gambling page contains self-exclusion or limit-setting tools @journey', async ({ page }) => {
    ...
    test('@regression footer link on homepage points to the RG hub @journey', async ({ page }) => {
