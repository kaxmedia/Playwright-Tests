...
// 2026-09-24: 2 further regressions found live (not part of the original PR #42 scoping) -- /ca now
// 404s (was serving fine at PR #42 time; matches the already-tracked /ca/online-casinos/bonus content
// gap from the Sprint 4 handoff) and /is now redirects straight to the homepage instead of serving a
// bonus page at all. Removed both from GEOS below rather than test.skip, matching how the original 14
// were excluded.
const GEOS = [
  { path: '/at', name: 'at' },
    { path: '/gr', name: 'gr' },
